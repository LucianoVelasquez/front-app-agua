...
export default function CardMedidor({medidorCliente} : any){
    ...
    let {medidor,cliente,lote,manzana,lectura_actual,fecha_instalacion,is_modificate} = medidorCliente;
    ...
    return(
        <Card >
            ...
            <View style={{alignItems:"flex-start"}}>
                ...
                <Text style={styles.text}>Lectura anterior: {lectura_actual}</Text>
                <Input
